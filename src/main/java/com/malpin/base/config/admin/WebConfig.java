package com.malpin.base.config.admin;
/**
 * 用来配置拦截器的配置类
 */
import com.malpin.base.interceptor.admin.AuthorityInterceptor;
import com.malpin.base.interceptor.admin.LoginInterceptor;
...
import com.malpin.base.constant.RuntimeConstant;
@Configuration

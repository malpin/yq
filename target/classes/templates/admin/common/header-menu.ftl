            ...
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                 <#if ylrc_user.headPic??>
                   ...
                   <#else>
                      <img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.png" alt="${ylrc_user.username!""}" />
                   </#if>
                 <#else>
                   <img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.png" alt="${ylrc_user.username!""}" />
                 </#if>
                <span>${ylrc_user.username!""} <span class="caret" style="color: #721c24"></span></span>
              </a>
